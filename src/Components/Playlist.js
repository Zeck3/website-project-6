export const Playlist = [ {
        ...
        Thumbnail: process.env.PUBLIC_URL + "/Assets/ThoughtCrimeThumbnail.png",
        Description: "The theme of Thought Crime is plagiarized from George Orwell's novel, '1984.' Then, the moment it's declared to be plagiarized, I change its form to that of an 'homage.' The line between plagiarism and paying homage to something seems ambiguous, and the truth is that that line doesn't actually exist at all. This holds true even when the roles are reversed. A homage holds a great risk of becoming plagiarism. The lyrics to this song pay homage to Ozaki Hosai's haiku and his final years of life. Surely, it can also be said that this is plagiarism."
    }, {
        Title: "盗作",
        MusicVideo: process.env.PUBLIC_URL + "/Assets/ヨルシカ - 盗作OFFICIAL VIDEO.webm",
        Thumbnail: process.env.PUBLIC_URL + "/Assets/PlagiarismThumbnail.png",
        Description: "The objective facts are plagiarism of all modern music. I have no intention of being intentional or unintentional. Both the melodic patterns and chord progressions are long gone. Still, the value of the work does not depend on the evaluation of others. Information, whether stolen or not, is only information. There is no real value there. Only the sense of hearing it at first and its beauty at first glance determines the value of the work to your life. Who would have decided that the “stolen work” was not enough? I'm a thief."
    }, {
        Title: "春ひさぎ",
        MusicVideo: process.env.PUBLIC_URL + "/Assets/ヨルシカ - 春ひさぎOFFICIAL VIDEO.webm",
        Thumbnail: process.env.PUBLIC_URL + "/Assets/ProstitutionThumbnail.png",
        Description: "Selling spring is jargon for prostitution. It functions here as a metaphor for 'music being sold like products.' Don't you think it's sad? It's more silly than real prostitution. To stay alive, we throw away our pride, choose themes to appeal to the masses, and put together pop melodies. Create beautifully verbalized and easy-to-understand works. In this way, I sell myself to you in the form of music. I call it selling spring."
    }, {
        Title: "斜陽",
        ...
        Thumbnail: process.env.PUBLIC_URL + "/Assets/That'sWhyIGaveUpOnMusicThumbnail.png",
        Description: null
    }
]
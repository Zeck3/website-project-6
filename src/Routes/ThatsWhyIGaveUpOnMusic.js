...
export default function ThatsWhyIGaveUpOnMusic() {
    ...
    return(
        <Main id="thatswhyigaveuponmusic" Poster={SpecifiedVideo.Thumbnail} MusicVideo={SpecifiedVideo.MusicVideo} Title={SpecifiedVideo.Title} Description={SpecifiedVideo.Description}>
